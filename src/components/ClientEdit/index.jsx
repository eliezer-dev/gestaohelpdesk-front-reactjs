import { Container, TicketMain, Select, SlaInput, NeighborhoodCityStateInput, CepAddressInput, NumberAddressLine2 } from "./styles";
...
export function ClientEdit({getDataForm, clientData}) {
    ...
    function handleSelectStates (event) {
        console.log(event)
    }
        ...
        <Container>
                <TicketMain>
                    ...
                    <Input
                        ...
                        type="text"
                        value={cpfCnpjState}
                        onChange={e => {setCpfCnpjState(e.target.value)}}
                        required
                    />
                    <CepAddressInput>
                        <Input
                    ...
                    <SlaInput>
                        <Input
                            ...
                            onChange={e => {setSlaDefaultState(e.target.value)}}
                            required
                        />
                        <Input
                            ...
                            onChange={e => {setSlaUrgencyState(e.target.value)}}
                            required
                        />
                    </SlaInput>
