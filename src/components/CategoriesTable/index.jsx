...
export function CategoriesTable({categories, rows, deleteCategory}) {
    ...
    function handleEditCategory (categoryId) {
        navigate(`/configurations/categories/${categoryId}`)
    }

    function handleDeleteCategory (categoryId, description) {
          ...
          <TableContainer component={Paper}>  
                <div className="contentTable">
                  ...
                  <TableHead>
                      ...
                      <TableCell sx={{width:50}}> Prioridade </TableCell>
                  ...
                  <TableBody>
                        ...
                        (rowsPerPage > 0
                          ...
                          <TableRow key={category.id}>
                            ...
                            <TableCell sx={{fontSize:14, width:50}} align="center">
                              {category?.priority}
                            </TableCell>
                            <TableCell  className="ticket_options" sx={{fontSize:14}}>
                              <EditIcon onClick={() => {handleEditCategory(category.id)}}/>
                              <DeleteIcon onClick={() => {handleDeleteCategory(category.id, category.description)}}/>
                            </TableCell>
